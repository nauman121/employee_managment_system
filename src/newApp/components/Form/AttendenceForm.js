...
const cancelHandler = () => {
    ...
    return (
        <Form>
        <div className='px-5' style={{ display: 'flex', flexDirection: 'row', gap: '3vw', marginLeft: '13vw',width:'40%',height:'40%',margin:'50px auto',padding:'30px 30px',border:'2px solid black' }}>
                <Form.Group as={Row}>
