...
const UpdateEmployee = () => {
  ...
  const handleChange = (e) => {
    ...
    setStore({ fileUrl: URL.createObjectURL(file), file, filename: file.name });
  };
  ...
  React.useEffect(() => {
    const results = GetEmployee.filter((person) => {
      if (
        (person.role === "lead" &&
          person.company.toLowerCase() === "lads technology") ||
        (person.role === "hr" &&
          person.company.toLowerCase() === "lads technology")
      ) {
        return true;
  ...
  const updateUser = async () => {
    try {
      const updateData = {
        ...
        employee_phone1: employee.employee_phone1,
        employee_phone2: employee.employee_phone2,
        ...
        last_degree: employee.last_degree,
        institute: employee.institute,
        transport_mode: employee.transport_mode,
        vichel_no: employee.vichel_no,
      };

      await API.graphql(
        graphqlOperation(updateEmployee, { input: updateData })
      );
  ...
  return (
    <>
      <div>
        <h1 id="role-form-title" className="m-2 p-3">
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({ ...employee, employee_email: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({ ...employee, employee_addr: e.target.value })
                  }
                  required
                />
              </Col>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({
                      ...employee,
                      employee_salary: parseInt(e.target.value),
                    })
                  }
                  required
                />
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({ ...employee, supervisor: e.target.value })
                  }
                  required
                >
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({ ...employee, last_degree: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({ ...employee, institute: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({ ...employee, transport_mode: e.target.value })
                  }
                  required
                />
              </Col>
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={10} className="form-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setEmployee({ ...employee, vichel_no: e.target.value })
                  }
                  required
                />
              </Col>
