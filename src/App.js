...
if(data.data.getEmployee.company.toLowerCase()==='lads technology' || data.data.getEmployee.role.toLowerCase()==='hr manager' || data.data.getEmployee.role.toLowerCase()==='owner'
){
