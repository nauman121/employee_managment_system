...
if(data.data.getEmployee.company.toLowerCase()==='lads technology' || data.data.getEmployee.role.toLowerCase()==='manager hr' || data.data.getEmployee.role.toLowerCase()==='owner'
){
